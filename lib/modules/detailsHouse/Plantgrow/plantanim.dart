...
import 'package:untitled6/modules/detailsHouse/Plantgrow/utils/time_utils.dart';
import 'package:untitled6/modules/detailsHouse/detailsHouse_screen.dart';
...
class _PlantScreenState extends State<PlantScreen> {
  ...
  void initState() {
    ...
    rootBundle.load('assets/pomodoro_tree.riv').then(
          (data) async {
